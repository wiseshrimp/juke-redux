...
describe('For a given promiseA (pA)', function(){
  ...
  describe('that returns promiseB (pB) via .then:', function(){
    ...
    it("if pA's error handler returns promiseZ which fulfills, pB mimics pZ", function(){
      var deferralZ = defer();
      var promiseZ = deferralZ.$promise;
    ...
    it("if pA's success handler returns promiseZ which rejects, pB mimics pZ", function(){
      var deferralZ = defer();
      var promiseZ = deferralZ.$promise;
      var promiseB = promiseA.then(function(){
        return promiseZ;
    ...
    it("if pA's error handler returns promiseZ which rejects, pB mimics pZ", function(){
      var deferralZ = defer();
      var promiseZ = deferralZ.$promise;
      var promiseB = promiseA.catch(function(){
        return promiseZ;
