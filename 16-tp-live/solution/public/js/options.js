...
$(function(){
  ...
  // we register the click when it bubbles up to the $optionsPanel
  // but the second argument to .on allows us to select only events
  // that originated on a button with attribute data-action="add"
